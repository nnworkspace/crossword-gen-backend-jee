...
public class WordpuzzleApi  {
  ...
  @Inject WordpuzzleApiService delegate;
    ...
    @ApiOperation(value = "", notes = "Returns a word search puzzle and its corresponding solution. ", response = PuzzleAndSolution.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "word puzzle generator response", response = PuzzleAndSolution.class, responseContainer = "List"),
